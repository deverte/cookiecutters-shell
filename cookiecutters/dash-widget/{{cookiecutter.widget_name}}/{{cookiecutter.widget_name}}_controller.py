"""{{cookiecutter.widget_name}} controller."""
...
from {{cookiecutter.widget_name}}.app import app
...
def {{cookiecutter.widget_name}}_callback(input_component_property_data, state_component_property_data):
